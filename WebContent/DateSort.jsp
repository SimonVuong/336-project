...
<% 
	try
	{
		...
		while(rs.next())
		{
			...
			{
				out.print("<div class=\"panel-heading\">");
				out.println("<h4>User: "+rs.getString("user")+"<span class =\"pull-right\"><a href = \"Vote.jsp?cid="+rs.getInt("cid")+"\">Upvote</a><a href = \"DownVote.jsp?cid="+rs.getInt("cid")+"\">  Downvote</a></span></h4>");
				out.println("Created: "+rs.getTimestamp("created"));
				out.println(" Comment Id:"+rs.getInt("cid"));
				out.println("Votes:"+rs.getInt("Votes"));
				out.println("</div>");
